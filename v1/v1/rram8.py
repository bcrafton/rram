...
class rram:
    ...
    def step(self, Vin, dt):
        ...
        # print (self.gamma * self.a0 / self.tox * self.q * self.Vtb / self.kb / self.T_cur)
        # print (self.gamma * self.a0 / self.tox * self.q)
        # print (self.gamma)
        ...
        self.gap += (self.gap_ddt + self.gap_random_ddt) / 1e4 * dt
